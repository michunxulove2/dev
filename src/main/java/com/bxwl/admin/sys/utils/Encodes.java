...
import com.bxwl.admin.sys.aop.Exceptions;
...
public class Encodes {
	...
	public static String encodeBase64(String input) {
		return Base64.encodeBase64String(input.getBytes(Charsets.UTF_8));
	}
...
//	}
	...
	public static byte[] decodeBase64(String input) {
		return Base64.decodeBase64(input.getBytes(Charsets.UTF_8));
	}
