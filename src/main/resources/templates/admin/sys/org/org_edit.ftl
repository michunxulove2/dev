		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<div class="layui-col-md12">
					<input type="text" name="orgId" autocomplete="off" class="layui-input layui-hide" value="${(sysOrg.orgId)!}">
					<input type="text" name="lng" id="lng" autocomplete="off" class="layui-input layui-hide" value="${(sysOrg.lng)!}">
					<input type="text" name="lat" id="lat" autocomplete="off" class="layui-input layui-hide" value="${(sysOrg.lat)!}">
					<input type="text" name="jobId" id="jobId" autocomplete="off" class="layui-input layui-hide" value="${(sysOrg.jobId)!}">
					<input type="text" name="orgName" lay-verify="required" lay-verType="tips" placeholder="请输入机构名称" 
						autocomplete="off" class="layui-input" value="${sysOrg.orgName}">
				</div>
			</div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<div class="layui-col-md12">
					<input type="text" name="loginName" lay-verify="required" placeholder="请输入管理员登陆账号" 
						autocomplete="off" class="layui-input layui-disabled" value="${sysOrg.loginName}" disabled>
				</div>
			</div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<div class="layui-col-md12">
					<input type="text" name="contactName" placeholder="请输入联系人姓名" 
						autocomplete="off" class="layui-input" value="${(sysOrg.contactName)!}">
				</div>
			</div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<div class="layui-col-md12">
					<input type="text" name="contactPhone" placeholder="请输入联系方式" 
						autocomplete="off" class="layui-input" value="${(sysOrg.contactPhone)!}">
				</div>
			</div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<div class="layui-col-md12">
					<input type="text" name="address" id="address" placeholder="请拖动地图选择地址"
						autocomplete="off" class="layui-input" value="${(sysOrg.address)!}">
				</div>
			</div>
		</div>
		<div class="layui-form-item">
...
<@scripts>
	...
	<script src="${application.getContextPath()}/js/admin/sys/org/org_edit.js"></script>
	<script>
		var _initCheck = true;
		layui.config({
