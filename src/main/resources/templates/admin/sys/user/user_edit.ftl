...
<div class="layui-form" lay-filter="layuiadmin-form-role" id="layuiadmin-form-role" style="padding: 20px 30px 0 0;">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <div class="layui-col-md12">
                ...
                <input type="text" name="loginName" lay-verify="required|loginName" lay-verType="tips"
                       placeholder="请输入登录名"
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<div class="layui-col-md12">
				<select name="departId" lay-verify="departId" lay-verType="tips" xm-select-radio>
					<#list departmentList as department>
						<#if sysUser.departId == department.id>
        ...
        <div class="layui-input-block">
            <div class="layui-col-md12">
                <input type="text" name="nickname" placeholder="请输入姓名"
                       autocomplete="off" lay-verify="nickname" lay-verType="tips" class="layui-input"
        ...
        <div class="layui-input-block">
            <div class="layui-col-md12">
                <input type="text" name="contactPhone" placeholder="请输入联系电话"
                       autocomplete="off" lay-verify="phone" lay-verType="tips" class="layui-input"
                       value="${(sysUser.contactPhone)!}">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <div class="layui-col-md12">
                <input type="text" name="email" placeholder="请输入邮箱"
                       autocomplete="off" lay-verify="email" lay-verType="tips" class="layui-input"
                       value="${(sysUser.email)!}">
            </div>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        <button class="layui-btn layui-hide" lay-submit lay-filter="add-sysUser-submit" id="add-sysUser-submit">提交
        </button>
    </div>
</div>
