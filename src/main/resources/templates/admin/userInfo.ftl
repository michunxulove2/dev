...
<body>
	<div class="layui-form" lay-filter="layuiadmin-form-role" id="layuiadmin-form-role" style="padding: 20px 30px 0 0;">
		...
		<#if jobList?? && (sysUser.ownerJobIdList)?? && (sysUser.ownerJobIdList?size > 0)>
		<div class="layui-form-item">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="radio" name="sex" value="1" title="男" <#if sysUser?? && sysUser.sex == 1 >checked</#if> disabled>
				<input type="radio" name="sex" value="0" title="女" <#if sysUser?? && sysUser.sex == 0>checked</#if> disabled>
			</div>
		</div>
		<div class="layui-form-item">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="radio" name="hasEnabled" value="Y" title="启用"  <#if sysUser?? && sysUser.hasEnabled == "Y">checked</#if> disabled>
				<input type="radio" name="hasEnabled" value="N" title="禁用"   <#if sysUser?? && sysUser.hasEnabled == "N">checked</#if> disabled>
			</div>
		</div>
		<div class="layui-form-item">
